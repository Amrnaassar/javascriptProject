...
function generateGame(){
    ...
    // Getting Variables to update global param
    color_x_o = Number(document.getElementById('color_x_o').value);
...
function markCheck(obj){
	...
	if (turn == 'X' && color_x_o == 1) {
		obj.setAttribute("class", 'green-player');
	} else if (turn == 'X' && color_x_o == 2) {
		obj.setAttribute("class", 'blue-player');
	} else if (turn == 'X' && color_x_o == 3) {
		obj.setAttribute("class", 'red-player');
	} else if (turn == 'O' && color_x_o == 1) {
		obj.setAttribute("class", 'red-player');
	} else if (turn == 'O' && color_x_o == 2) {
		obj.setAttribute("class", 'yellow-player');
	} else {
		obj.setAttribute("class", 'blue-player');
	}
